...
var __vue_staticRenderFns__$2 = [];
  ...
  const __vue_inject_styles__$2 = function (inject) {
    if (!inject) return
    inject("data-v-ac652ef2_0", { source: ".vemoji-main[data-v-ac652ef2]{position:relative;display:inline-block}.vemoji-main--target[data-v-ac652ef2]{cursor:pointer;user-select:none}.vemoji-main--content[data-v-ac652ef2]{position:absolute;margin-top:8px;left:0;border:1px solid #eee;width:380px;background-color:#fff;padding-bottom:30px;border-radius:3px;box-shadow:0 2px 8px rgba(110,110,110,.2);overflow:hidden;z-index:99}.vemoji-main--content__head[data-v-ac652ef2]{max-height:600px;word-break:break-all;overflow:auto;padding:12px 16px}.vemoji-main--content__footer[data-v-ac652ef2]{height:30px;line-height:30px;position:absolute;width:100%;bottom:0;background-color:#f2f4f7;font-size:14px;color:#555}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$2 = "data-v-ac652ef2";
  /* module identifier */
