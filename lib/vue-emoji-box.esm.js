  ...
  const __vue_component__$1 = normalizeComponent(
    ...
    VueEmojiBox.prototype.mounted = function () {
        ...
        this.$nextTick(function () {
            // document 绑定click事件
            document.addEventListener('click', _this.hidePanel, false);
            if (_this.targetId) {
    ...
    // 点击除弹出层外的空白区域
    VueEmojiBox.prototype.hidePanel = function (event) {
        var vEl = this.$refs.vemojiMainBox;
...
/* template */
var __vue_render__$2 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"vemojiMainBox",staticClass:"vemoji-main",class:_vm.className},[(_vm.label)?_c('div',{staticClass:"vemoji-main--target",on:{"click":_vm.bindBoxVisible}},[(_vm.$slots.label)?_c('span',[_vm._t("label")],2):_c('span',[_vm._v(_vm._s(_vm.label))])]):_vm._e(),_vm._v(" "),(_vm.showBox)?_c('div',{staticClass:"vemoji-main--content",style:({ width: _vm.width })},[_c('div',{staticClass:"vemoji-main--content__head",style:({ height: _vm.height })},[_c('emoji-list',{attrs:{"base-url":_vm.baseUrl,"emoji-data":_vm.customEmojis,"category":_vm.currentCategory},on:{"select":_vm.bindChangeEmoji}})],1),_vm._v(" "),_c('div',{staticClass:"vemoji-main--content__footer"},[_c('category-list',{attrs:{"category-data":_vm.customCategories,"current":_vm.currentCategory},on:{"select":_vm.bindChangeCategory}})],1)]):_vm._e()])};
var __vue_staticRenderFns__$2 = [];

  /* style */
  const __vue_inject_styles__$2 = function (inject) {
    if (!inject) return
    inject("data-v-9185e37c_0", { source: ".vemoji-main[data-v-9185e37c]{position:relative;display:inline-block}.vemoji-main--target[data-v-9185e37c]{cursor:pointer;user-select:none}.vemoji-main--content[data-v-9185e37c]{position:absolute;margin-top:8px;left:0;border:1px solid #eee;width:380px;background-color:#fff;padding-bottom:30px;border-radius:3px;box-shadow:0 2px 8px rgba(110,110,110,.2);overflow:hidden;z-index:99}.vemoji-main--content__head[data-v-9185e37c]{max-height:600px;word-break:break-all;overflow:auto;padding:12px 16px;text-align:left}.vemoji-main--content__footer[data-v-9185e37c]{height:30px;line-height:30px;text-align:left;position:absolute;width:100%;bottom:0;background-color:#f2f4f7;font-size:14px;color:#555}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$2 = "data-v-9185e37c";
  /* module identifier */
...
};export default __vue_component__$2;export{VueEmojiBox$1 as VueEmojiBox,renewHtml};